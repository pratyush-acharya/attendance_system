...
@include('layouts.basic.tableHead',["table_title" => "Assign Students to Section"])

<div class="container1">
    <form action="{{ route('student-group-assign.store')}}" method='POST' name="myform" class="form-group">
        @csrf
